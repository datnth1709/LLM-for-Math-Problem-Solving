...
from multiagent.agent import initialize_agents, config_list
from utils.autogen_utils import *

assistant, userproxy, math_proxy_agent = initialize_agents()
...
def initiate_chat(config_list, user_message, chat_history):
    ...
    try:
        math_proxy_agent.initiate_chat(assistant, message=user_message)
        messages = math_proxy_agent.chat_messages
